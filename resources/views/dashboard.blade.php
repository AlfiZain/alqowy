    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                @if (session('message'))
                    <div class="p-3 w-full rounded-3xl bg-green-500 text-white">
                        {{ session('message') }}
                    </div>
                @endif
                @role('owner')
                    <div class="item-card flex flex-wrap gap-y-10  justify-between items-center text-center">
                ...
                @endrole
                @role('student')
                    <h3 class="text-indigo-950 font-bold text-2xl">Recent Courses</h3>
