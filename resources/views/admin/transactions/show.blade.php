            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        <div>
                            <p class="text-slate-500 text-sm">Subscription Start Date</p>
                        ...
                        <div>
                            ...
                            @if ($subscribeTransaction->is_paid)
                                <span class="px-6 py-2 bg-green-500 text-white font-bold rounded-full">
                                    ACTIVE
                                </span>
                            @else
                                <span class="px-6 py-2 bg-orange-500 text-white font-bold rounded-full">PENDING
                                </span>
                            @endif
                        </div>
                        <div>
