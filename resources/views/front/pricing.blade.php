<x-front>
    ...
    <section class="max-w-[1100px] w-full mx-auto absolute -translate-x-1/2 left-1/2 top-[170px]">
        @if (session('message'))
            <div class="p-3 mb-8 rounded-3xl w-full bg-orange-500 text-white">
                {{ session('message') }}
            </div>
        @endif
        <div class="flex flex-col gap-[30px] items-center">
            ...
            <div class="max-w-[1000px] w-full flex flex-col md:flex-row items-center md:items-start gap-[30px]">
                <div
                    class="flex flex-col rounded-3xl p-8 w-4/5 gap-[30px] bg-white h-fit ring-2 ring-sky-200 hover:ring-[#FF6129]">
                    <div class="flex flex-col gap-5">
                        <div class="flex flex-col gap-4">
                            <p class="font-semibold text-3xl lg:text-4xl leading-[54px]">Scholarship</p>
                            <p class="text-[#475466] text-base md:text-lg">Access to few online courses that helps you
                                to jump
                                started your new career path</p>
                        </div>
                        <div class="flex flex-col gap-1">
                            <p class="font-semibold text-3xl lg:text-4xl leading-[54px]">Rp 0</p>
                            <p class="text-[#475466] text-base md:text-lg">Forever Free</p>
                        </div>
                        <div class="flex flex-col gap-4">
                ...
                <div
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex flex-col gap-4">
                            <p class="font-semibold text-3xl lg:text-4xl leading-[54px]">Premium</p>
                            <p class="text-[#475466] text-base md:text-lg">All access to more than 20,000 online courses
                                to grow your
                                future career easily</p>
                        </div>
                        <div class="flex flex-col gap-1">
                            <p class="font-semibold text-3xl lg:text-4xl leading-[54px]">Rp 39000</p>
                            <p class="text-[#475466] text-base md:text-lg">Monthly</p>
                        </div>
                        <div class="flex flex-col gap-4">
                            <div class="flex gap-3">
                                <div class="w-6 h-6 flex shrink-0">
    ...
    <section id="Zero-to-Success"
        class="h-[885px] mt-[450px] sm:mt-[120px] md:mt-[320px] max-w-[1200px] mx-auto flex flex-col justify-end py-[70px] px-[50px] gap-[30px] bg-[#F5F8FA]">
