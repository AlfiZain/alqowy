<x-front>
    <div id="checkout-section" style="background-image: url( {{ asset('../assets/background/hero-banner.png') }})"
        ...
        <div class="flex flex-col gap-[10px] items-center">
            ...
            <h2 class="font-bold text-[40px] leading-[60px] text-white text-center">Checkout Subscription</h2>
        </div>
        <div class="flex flex-col md:flex-row gap-10 px-[80px] relative z-10">
            <div class="md:w-[450px] flex flex-col bg-white rounded-2xl p-5 gap-4 h-fit">
                <p class="font-bold text-lg">Package</p>
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3">
                        <div class="w-[50px] h-[50px] flex rounded-full overflow-hidden">
                ...
                <p class="font-semibold text-[28px] leading-[42px]">Rp 39000</p>
            </div>
