...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        // Menggunakan resource agar mempermudak pengaksesan, pada url di href nanti hanya perlu memanggil class.function e.g.:admin.courses.index
        Route::resource('course_videos', CourseVideoController::class)
            ->middleware('role:owner|teacher');

        // Tidak menggunakan resource karna membutuhkan parameter e.g.:{course:id}
